...
}d.preventDefault()}function ra(d){if(!da()&&!Q())return d.touches;d=
...
A+a.s+"/files/GoFixedSizeIcon.png")};this.v=function(b){a.i=b;if(a.i){
    // 全屏模式
    v.style.position="fixed";  // 改为 fixed 确保覆盖整个视口
    v.style.left="0px";
    v.style.top="0px";
    v.style.width="100%";
    v.style.height="100%";
    ...
    // 设置容器大小为视口大小
    a.h.style.width="100vw";
    a.h.style.height="100vh";
...
// 强制全屏并重置
setTimeout(function(){a.v(true);I();},100);
